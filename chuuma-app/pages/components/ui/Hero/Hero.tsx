	...
	return (
		...
		<div
					...
					<div className="flex flex-row justify-between items-center w-full">
						<h1 className="flex-1 font-poppins font-semibold ss:text-[40px] text-[40px] ss:leading-[100.8px] leading-[75px]">
			...
			<h1 className="text-[30px] pt-4 pb-3 text-center">Contact us on 0771626807</h1>
			<SocialContacts />
